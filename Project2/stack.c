...
/*
d?* This function should free the memory associated with a stack.  While this
...
void* stack_pop(struct stack* stack){
  ...
  if(stack->list == NULL){
    ...
    catch_pop = stack->list->val;
    stack->list = stack->list->next;
    return catch_pop;
  }
  */
  return stack_pop_2(stack->list);
}
