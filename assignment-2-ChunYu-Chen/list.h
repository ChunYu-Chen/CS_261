...
void* get_top(struct list* list); // additional function (#1).
void* stack_pop_2(struct list* list);// additional function (#2).
int check_empty(struct list* list);// additional function (#3)
